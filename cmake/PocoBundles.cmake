...
function(ADD_POCO_BUNDLE_DEPENDENCY target dependency)
    ...
    elseif(args_MIN_VERSION VERSION_LESS args_MAX_VERSION)
    	...
    	get_target_property(version_string ${dependency} POCO_BUNDLE_VERSION)
    endif()
    if(TARGET ${dependency}) 
    	...
    	set_property(TARGET ${target} PROPERTY _POCO_BUNDLE_DEPENDENCY_${dependency}_VERSION ${version_string})
    	get_target_property(symbolic ${dependency} POCO_BUNDLE_SYMBOLIC_NAME)
    	set_property(TARGET ${target} APPEND_STRING PROPERTY POCO_BUNDLE_DEPENDENCY "${symbolic}@${version_string},")
